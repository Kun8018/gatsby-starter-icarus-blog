...
通过 Gatsby cli，你可以快速建立一个如同 [Kun's Blog](https://kunzhang.me) 的博客系統。
...
你可以直接修改 `/src/content/*.md`，或者接入 [Netlify-cms](https://www.netlifycms.org) cms 系统来管理，也可以期待后续支持 Notion 更为方便。
